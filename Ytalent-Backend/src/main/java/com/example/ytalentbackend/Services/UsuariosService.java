...
public class UsuariosService {
    ...
    // Estructura para almacenar códigos de verificación en memoria (ejemplo simple)
    private final Map<Integer, VerificationCode> verificationCodes = new HashMap<>();
    @Autowired
    ...
    public void saveVerificationCode(Integer userId, String code) {
        verificationCodes.put(userId, new VerificationCode(code, LocalDateTime.now().plusMinutes(10)));
    }
    ...
    public boolean validateVerificationCode(Integer userId, String code) {
        ...
        if (verificationCode != null && verificationCode.getCode().equals(code) && !verificationCode.getExpirationTime().isBefore(LocalDateTime.now())) {
            verificationCodes.remove(userId); // Remove code after validation
            return true;
        }
        return false;
    }
    ...
    public void sendPasswordRecoveryEmail(String correo) {
        ...
        if (optionalUsuario.isPresent()) {
            ...
            String htmlContent = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                    ...
                    "}\n" +
                    "\n" +
                    "table, td { color: #000000; } @media (max-width: 480px) { #u_column_2 .v-col-border { border-top: 5px solid #8d95ff !important;border-left: 5px solid #8d95ff !important;border-right: 5px solid #8d95ff !important;border-bottom: 5px solid #8d95ff !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 10px !important; } #u_content_text_1 .v-container-padding-padding { padding: 10px 10px 40px !important; } }\n" +
                    "    </style>\n" +
                    "  \n" +
                    "  \n" +
                    "\n" +
                    ...
                    "    <p style=\"line-height: 140%;\"><span data-metadata=\"&lt;!--(figmeta)eyJmaWxlS2V5IjoiTHJJMHBSU20xM203UWc0Tk1XZXVQeCIsInBhc3RlSUQiOjE4NjYyMDI5OTgsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;\" style=\"line-height: 19.6px;\"></span>Aqui esta tu codigo de verificación para restablecer tu contraseña</p>\n" +
                    "<p style=\"line-height: 140%;\"> </p>\n" +
                    "<p style=\"line-height: 140%;\"><strong>Codigo: "+code+"</strong> </p>\n" +
                    "<p style=\"line-height: 140%;\"><br /><em><strong>Recuerda que este codigo es valido por los siguietes 10 minutos </strong></em></p>\n" +
                    "  </div>\n" +
                    "\n" +
                    "      </td>\n" +
                    "    </tr>\n" +
                    ...
                    "      \n" +
                    "      <img align=\"center\" border=\"0\" src=\"https://i.postimg.cc/WbfHhCSd/image-1.png\" alt=\"Verification Image\" title=\"image\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 90%;max-width: 540px;\" width=\"540\"/>\n" +
                    "      \n" +
                    "    </td>\n" +
                    "  </tr>\n" +
                    "</table>\n" +
    ...
    // Clase para almacenar códigos de verificación y su tiempo de expiración
